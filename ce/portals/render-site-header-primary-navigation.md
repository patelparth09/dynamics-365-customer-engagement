            ...
            {% if user %}
              <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu" id="profile-dropdown">
                  ...
                  <li>
                    <a href="/account/login/logoff?returnUrl={{ request.raw_url }}" role="button">
            ...
            {% else %}
              <div class="btn-group">
                <a class="btn btn-primary"
                  href={{ "SignIn" | add_query:'returnurl', request.path_and_query }}>
                    ...
                    {% for sublink in sublinks %}
                      <li>
                        <a href="{{ sublink.url }}"
                          ...
                          {% if sublink.image %}
                    {% if sublink.image.url startswith '.' %}
                      <span class="{{ sublink.image.url | split:'.' | join }}" aria-hidden="true"></span>
                    {% else %}
                      <img src="{{ sublink.image.url }}"
                        alt="{{ sublink.image.alternate_text | default:sublink.tooltip }}"
                        {% if sublink.image.width %}width="{{ sublink.image.width }}"{% endif %}
                        {% if sublink.image.height %}height="{{ sublink.image.height }}"{% endif %}
                      />
                    {% endif %}
                  {% endif %}
